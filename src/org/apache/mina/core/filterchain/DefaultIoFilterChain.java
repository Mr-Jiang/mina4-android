...
public class DefaultIoFilterChain implements IoFilterChain {
	...
	private static final String TAG = DefaultIoFilterChain.class.getName();
	 ...
	 * contain a HeadFilter and a TailFilter.
	 *
	 * @param session
	...
	private void callNextExceptionCaught(Entry entry, IoSession session, Throwable cause) {
		...
		if (future == null) {
			try {
				...
				Mina4Log.w(TAG, "Unexpected exception from exceptionCaught handler.\n" + e.toString());
			}
		} else {
