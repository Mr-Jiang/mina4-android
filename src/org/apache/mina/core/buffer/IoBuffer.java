 ...
 * <li>It is difficult to write variable-length data due to its fixed capacity
 * </li>
 * </ul>
 * 
 * <h2>Allocation</h2>
...
public abstract class IoBuffer implements Comparable<IoBuffer> {
	 ...
	 *         default when the type of the new buffer is not specified. The
	...
	/**
	 * Returns a direct or heap IoBuffer which can contain the specified number
	 * of bytes.
	 * 
	 * @param capacity
	 *            the capacity of the buffer
	...
	/**
	 * Wraps the specified NIO {@link ByteBuffer} into a MINA buffer (either
	 * direct or heap).
	 * 
	 * @param nioBuffer
	...
	/**
	 * Wraps the specified byte array into a MINA heap buffer. Note that the
	 * byte array is not copied, so any modification done on it will be visible
	 * by both sides.
	 * 
	 * @param byteArray
	 ...
	 * bytes starting from offset up to offset + length. Note that the byte
	 * array is not copied, so any modification done on it will be visible by
	 * both sides.
	 * 
	 * @param byteArray
	 *            The byte array to wrap
	 ...
	 *            The IoBuffer capacity we want to be able to store
	 ...
	 *         the new capacity of the buffer shrunk by the {@link #compact()}
	 *         and {@link #shrink()} operation. The default value is the initial
	 *         capacity of the buffer.
	 */
	 ...
	 * or equal to the current capacity, this method returns the original
	 * buffer. If the new capacity is greater than the current capacity, the
	 * buffer is reallocated while retaining the position, limit, mark and the
	 * content of the buffer. <br>
	 ...
	 * capacity is C, here are the resulting buffer if we set the new capacity
	 * to a value V &lt; C and V &gt; C :
	 * 
	 * <pre>
	 *  Initial buffer :
	 *   
	 ...
	 * 
	 * @param autoExpand
	 *            The flag value to set 要设置的标志值
	 * @return The modified IoBuffer instance 修改后的IoBuffer实例
	 */
	 ...
	 *            The expected remaining bytes in the buffer
	 * @return The modified IoBuffer instance
	 */
	 ...
	 * <tt>autoExpand</tt> to <tt>true</tt>. Assuming a buffer contains N bytes,
	 * its position is P and its current capacity is C, here are the resulting
	 * buffer if we call the expand method with a expectedRemaining value V :
	 * 
	 * <pre>
	 *  Initial buffer :
	 *   
	 ...
	 * instance, if the limit is 7 and the capacity is 36, with a minimum
	 * capacity of 8, shrinking the buffer will left a capacity of 9 (we go down
	 * from 36 to 18, then from 18 to 9).
	 * 
	 * <pre>
	 *  Initial buffer :
	 *   
	 ...
	 * 
	 * @param newPosition
	 *            Sets the new position in the buffer
	 ...
	 * 
	 * @return the modified IoBuffer 修改后的IoBuffer
	 * 
	 */
	 ...
	 * 
	 * @return The offset in the returned byte[] when the {@link #array()}
	 *         method is called
	 */
	 ...
	 * 
	 * @param index
	 *            The position for which we want to read a byte
	 ...
	 * 
	 * @param index
	 *            The position for which we want to read an unsigned byte
	 ...
	 * 
	 * @param index
	 *            The position where the byte will be put
	 * @param b
	 *            The byte to put
	 * @return the modified IoBuffer
	 * 
	 ...
	 * @param offset
	 *            The position in the original buffer
	 * @param length
	 ...
	 *
	 * @param dst
	 *            The byte[] that will contain the read bytes
	 * @return the IoBuffer
	 */
	 ...
	 * 
	 * @param bo
	 *            The new ByteBuffer to use for this IoBuffer
	 * @return the modified IoBuffer
	 */
	 ...
	 * 
	 * @param value
	 *            The char to put at the current position
	 * @return the modified IoBuffer
	 */
	 ...
	 * 
	 * @param index
	 *            The index in the IoBuffer where we will read a char from
	 ...
	 * 
	 * @param index
	 *            The index in the IoBuffer where we will put a char in
	 * @param value
	 *            The char to put at the current position
	 * @return the modified IoBuffer
	 */
	 ...
	 * 
	 * @param value
	 *            The short to put at the current position
	 * @return the modified IoBuffer
	 */
	 ...
	 * 
	 * @param index
	 *            The index in the IoBuffer where we will read a short from
	 * @return The read short
	 */
	 ...
	 * 
	 * @param index
	 *            The position at which the short should be written
	 * @param value
	 *            The short to put at the current position
	 * @return the modified IoBuffer
	 */
	 ...
	 * 
	 * @param value
	 *            The int to put at the current position
	 * @return the modified IoBuffer
	 */
	 ...
	 * 
	 * @param index
	 *            the position in the buffer to write the unsigned short
	 * @param value
	 ...
	 * 
	 * @param index
	 *            the position in the buffer to write the short
	 * @param value
	 *            the long to write
	 * 
	 * @return the modified IoBuffer
	 ...
	 * @param index
	 *            The index in the IoBuffer where we will read an int from
	 ...
	 * 
	 * @param index
	 *            The position where to put the int
	 * @param value
	 *            The int to put in the IoBuffer
	 * @return the modified IoBuffer
	 */
	 ...
	 * 
	 * @param value
	 *            The log to put in the IoBuffer
	 * @return the modified IoBuffer
	 */
	 ...
	 * 
	 * @param index
	 *            The index in the IoBuffer where we will read a long from
	 * @return the long at the given position
	 */
	 ...
	 * 
	 * @param index
	 *            The position where to put the long
	 * @param value
	 *            The long to put in the IoBuffer
	 * @return the modified IoBuffer
	 */
	 ...
	 *
	 * @param value
	 *            The float to put in the IoBuffer
	 * @return the modified IoBuffer
	 */
	 ...
	 * 
	 * @param index
	 *            The index in the IoBuffer where we will read a float from
	 ...
	 * 
	 * @param index
	 *            The position where to put the float
	 * @param value
	 *            The float to put in the IoBuffer
	 * @return the modified IoBuffer
	 */
	 ...
	 * 
	 * @param value
	 *            The double to put at the IoBuffer current position
	 * @return the modified IoBuffer
	 */
	 ...
	 * 
	 * @param index
	 *            The position where to get the double from
	 ...
	 * 
	 * @param index
	 *            The position where to put the double
	 * @param value
	 *            The double to put in the IoBuffer
	 * @return the modified IoBuffer
	 */
	 ...
	 *         {@link InputStream#read()} returns <tt>-1</tt> if the buffer
	 ...
	 *         in case of buffer overflow. Please set <tt>autoExpand</tt>
	 *         property by calling {@link #setAutoExpand(boolean)} to prevent
	 ...
	 * 
	 * @param decoder
	 *            The {@link CharsetDecoder} to use
	 ...
	 * <p>
	 * 使用指定的编码器将in的内容写入此缓冲区。 此方法不会使用NUL终止字符串。 你必须自己做
	 * <p>
	 * 
	 * @param val
	 *            The CharSequence to put in the IoBuffer
	 *            放入IoBuffer的CharSequence
	 * @param encoder
	 *            The CharsetEncoder to use 使用CharsetEncoder
	 * @return The modified IoBuffer 修改后的IoBuffer
	 * @throws CharacterCodingException
	 *             When we have an error while decoding the String 解码字符串时可能出现的错误
	 */
	 ...
	 * 
	 * @param val
	 *            The CharSequence to put in teh IoBuffer
	 * @param prefixLength
	 *            the length of the length field (1, 2, or 4)
	 * @param padding
	 ...
	 * 
	 * @param classLoader
	 *            The classLoader to use to read an Object from the IoBuffer
	 * @return The read Object
	 * @throws ClassNotFoundException
	 *             thrown when we can't find the Class to use
	 */
	 ...
	 * 
	 * @param o
	 *            The Object to write in the IoBuffer 要在IoBuffer中写入的对象
	 * @return The modified IoBuffer 修改后的IoBuffer
	 */
	 ...
	 *         . Please not that using this method can allow DoS (Denial of
	 *         Service) attack in case the remote peer sends too big data length
	 ...
	 * 
	 * @param value
	 *            The value to fill the IoBuffer with
	 * @param size
	 *            The added size
	 * @return The modified IoBuffer
	 */
