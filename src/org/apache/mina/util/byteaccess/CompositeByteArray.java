...
public final class CompositeByteArray extends AbstractByteArray {
	...
	/**
	 * Allows for efficient detection of component boundaries when using a
	 * cursor.
	 *
	...
	public interface CursorListener {
		...
		/**
		 * Called when the previous component in the composite is entered by the
		 * cursor.
		 * 
		 * @param componentIndex
		 *            The component position
	...
	/**
	 * Adds the specified {@link ByteArray} to the first position in the list
	 *
	 * @param ba
	 ...
	 * 
	 * @param index
	 *            The index from where we will remove bytes
