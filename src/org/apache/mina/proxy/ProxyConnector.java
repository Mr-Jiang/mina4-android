...
public class ProxyConnector extends AbstractIoConnector {
	...
	/**
	 * This future will notify it's listeners when really connected to the
	 * target
	 */
	 ...
	 * 
	 * @param connector
	 *            Connector used to establish proxy connections.
	 */
	 ...
	 * 
	 * @param connector
	 *            The Connector used to establish proxy connections.
	 * @param config
	 *            The session confiugarion to use
	 * @param executor
	 ...
	 *            the configuration of this connector.
	 */
	 ...
	 * @return {@link ConnectFuture} that will tell the result of the connection
	 *         attempt
	 */
	...
	protected ConnectFuture connect0(final SocketAddress remoteAddress, final SocketAddress localAddress,
		...
		ConnectFuture conFuture = connector.connect(proxyIoSession.getProxyAddress(),
				new ProxyIoSessionInitializer(sessionInitializer, proxyIoSession));
	...
	/**
	 * @return the {@link SocketConnector} to be used for connections to the
	 *         proxy server.
	 */
	...
	/**
	 * Sets the {@link SocketConnector} to be used for connections to the proxy
	 * server.
	 * 
	 * @param connector
