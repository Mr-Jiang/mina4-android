...
public class ProtocolCodecFilter extends IoFilterAdapter {
	...
	private static final String TAG = ProtocolCodecFilter.class.getName();
	...
	/**
	 * Creates a new instance of ProtocolCodecFilter, associating a factory for
	...
	private void disposeEncoder(IoSession session) {
		...
		try {
			...
			Mina4Log.w(TAG, "Failed to dispose: " + encoder.getClass().getName() + " (" + encoder + ')');
		}
	}
	...
	private void disposeDecoder(IoSession session) {
		...
		try {
			...
			Mina4Log.w(TAG, "Failed to dispose: " + decoder.getClass().getName() + " (" + decoder + ')');
		}
	}
