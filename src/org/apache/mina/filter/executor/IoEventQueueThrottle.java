...
public class IoEventQueueThrottle implements IoEventQueueHandler {
	...
	private static final String TAG = IoEventQueueThrottle.class.getName();
	...
	private void logState() {
		Mina4Log.d(TAG, Thread.currentThread().getName() + " state: " + counter.get() + " / " + getThreshold());
	}

	protected void block() {
		Mina4Log.d(TAG, Thread.currentThread().getName() + " blocked: " + counter.get() + " >= " + threshold);
		...
		Mina4Log.d(TAG, Thread.currentThread().getName() + " unblocked: " + counter.get() + " < " + threshold);
	}
