...
public final class NioSocketConnector extends AbstractPollingIoConnector<NioSession, SocketChannel>
	...
	/**
	 * Constructor for {@link NioSocketConnector} with default configuration,
	 * and given number of {@link NioProcessor} for multithreading I/O
	 * operations
	 * 
	...
	/**
	 * Constructor for {@link NioSocketConnector} with default configuration but
	 * a specific {@link IoProcessor}, useful for sharing the same processor
	...
	/**
	 * Constructor for {@link NioSocketConnector} with a given {@link Executor}
	 * for handling connection events and a given {@link IoProcessor} for
	 * handling I/O events, useful for sharing the same processor and executor
	 * over multiple {@link IoService} of the same type.
	 * 
	 * @param executor
	...
	/**
	 * Constructor for {@link NioSocketConnector} with default configuration
	 * which will use a built-in thread pool executor to manage the given number
	 * of processor instances. The processor class must have a constructor that
	 * accepts ExecutorService or Executor as its single argument, or, failing
	 * that, a no-arg constructor.
	 * 
	...
	/**
	 * Constructor for {@link NioSocketConnector} with default configuration
	 * with default configuration which will use a built-in thread pool executor
	 * to manage the default number of processor instances. The processor class
	 * must have a constructor that accepts ExecutorService or Executor as its
	 * single argument, or, failing that, a no-arg constructor. The default
	 * number of instances is equal to the number of processor cores in the
	 * system, plus one.
	 * 
	 * @param processorClass
	 *            the processor class.
