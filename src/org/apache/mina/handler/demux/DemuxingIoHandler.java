...
/**
 * A {@link IoHandler} that demuxes <code>messageReceived</code> events to the
 * appropriate {@link MessageHandler}.
 * <p>
 ...
 * repeated recursively for the superclass of the immediate class (i.e.
 * <code>message.getClass().getSuperclass()</code>).
 * <p>
...
public class DemuxingIoHandler extends IoHandlerAdapter {
	 ...
	 * 
	 * @param <E>
	 *            The message handler's type
	 * @param type
	 *            The message's type
	 * @param handler
	 *            The message handler
	 * @return the old handler if there is already a registered handler for the
	 *         specified <tt>type</tt>. <tt>null</tt> otherwise.
	 */
	...
	/**
	 * Registers a {@link MessageHandler} that receives the messages of the
	 * specified <code>type</code>.
	 *
	 * @param <E>
	 *            The message handler's type
	...
	/**
	 * Deregisters a {@link MessageHandler} that receives the messages of the
	 * specified <code>type</code>.
	 *
	 * @param <E>
	 *            The Exception Handler's type
	 * @param type
	 *            The message's type
	 * @return the removed handler if successfully removed. <tt>null</tt>
	 *         otherwise.
	...
	/**
	 * @return the {@link MessageHandler} which is registered to process the
	 *         specified <code>type</code>.
	 * @param <E>
	 *            The message handler's type
	 * @param type
	...
	/**
	 * @return the {@link Map} which contains all messageType-
	 *         {@link MessageHandler} pairs registered to this handler for
	 *         received messages.
	 */
	...
	/**
	 * @return the {@link Map} which contains all messageType-
	 *         {@link MessageHandler} pairs registered to this handler for sent
	 *         messages.
	 */
	...
	/**
	 * @return the {@link Map} which contains all messageType-
	 *         {@link MessageHandler} pairs registered to this handler.
	 */
	 ...
	 * {@link #addReceivedMessageHandler(Class, MessageHandler)}.
	 * 
	 * <b>Warning !</b> If you are to overload this method, be aware that you
	 * _must_ call the messageHandler in your own method, otherwise it won't be
	 * called.
	 * 
	 * {@inheritDoc}
	 */
	...
	@SuppressWarnings("unchecked")
	private Object findHandler(Map<Class<?>, ?> handlers, @SuppressWarnings("rawtypes") Map handlerCache, Class<?> type,
