 ...
 * <p>
 * Please extend this class and implement processStreamIo(IoSession,
 * InputStream, OutputStream) to execute your stream I/O logic; <b>please note
...
public abstract class StreamIoHandler extends IoHandlerAdapter {
	...
	private static final String TAG = StreamIoHandler.class.getName();
	 ...
	 * that you must forward the process request to other thread or thread
	 * pool.</b>
	 * 
	 * @param session
	 *            The current session
	...
	/**
	 * @return read timeout in seconds. The default value is <tt>0</tt>
	 *         (disabled).
	 */
	...
	/**
	 * Sets read timeout in seconds. The default value is <tt>0</tt> (disabled).
	 * 
	 * @param readTimeout
	 *            The Read timeout
	 */
	...
	/**
	 * @return write timeout in seconds. The default value is <tt>0</tt>
	 *         (disabled).
	 */
